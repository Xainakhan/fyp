...
interface RegisterModalProps {
  open: boolean;
  onClose: () => void;
  onSwitchToLogin: () => void; // switches back to login modal
}
  ...
  return (
    <>
      <style>{`
        ...
        .rm-input:focus { border-bottom-color: rgba(255,255,255,0.55); }
        ...
        @media (max-width: 480px) {
          .rm-card { right: 12px; left: 12px; width: auto; top: 76px; min-height: auto; }
        }
      `}</style>
