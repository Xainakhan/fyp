  ...
  return (
    <div className="w-full px-4 md:px-8 pt-1 md:pt-13 pb-10 text-white">
      <div className="relative w-full max-w-[1300px] mx-auto 
        ...
        {/* Flip row direction in Urdu so image goes to the right */}
        <div className={`flex flex-col ${isRTL ? "md:flex-row-reverse" : "md:flex-row"} items-center h-full gap-8 md:gap-16`}>
          ...
          {/* TEXT CONTENT */}
          <div className={`max-w-[520px] text-white ${isRTL ? "text-right" : "text-center md:text-left"}`}>
            ...
            {/* STORE BUTTONS — centered in Urdu, left-aligned in English */}
            <div className={`flex flex-col sm:flex-row gap-3 mt-6 items-center
              ${isRTL ? "justify-center" : "justify-center md:justify-start md:items-start"}`}
            >

              {/* Google Play */}
              <div className="flex items-center gap-3 bg-black px-4 py-2 rounded-lg cursor-pointer hover:scale-105 transition w-full sm:w-auto justify-center">
                ...
                <div className="text-left leading-tight">
                  <p className="text-[10px] text-white/70">{t("heroSection.googlePlay.label")}</p>
                  <p className="text-sm font-semibold">{t("heroSection.googlePlay.title")}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 bg-black px-4 py-2 rounded-lg cursor-pointer hover:scale-105 transition w-full sm:w-auto justify-center">
                ...
                <div className="text-left leading-tight">
                  <p className="text-[10px] text-white/70">{t("heroSection.appStore.label")}</p>
                  <p className="text-sm font-semibold">{t("heroSection.appStore.title")}</p>
                </div>
              </div>
