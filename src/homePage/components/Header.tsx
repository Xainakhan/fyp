  ...
  return (
    <div className="relative w-full min-h-[420px] rounded-2xl overflow-hidden">
      ...
      <div
        ...
        shadow-[inset_0_0_0_1px_rgba(255,255,255,0.1),0_10px_40px_rgba(0,0,0,0.4)]"
      />
      ...
      {/* Content */}
      <div className="relative z-10 flex flex-col md:flex-row items-center h-full px-6 py-10 md:px-16 md:py-0 gap-8 md:gap-16">
        {/* IMAGE */}
